...
let var11 = prompt("Quel est votre nom ?");
alert("Bonjour " + var11);
let var12 = prompt("Tu as quel âge ?");
alert("Tu as " + var12);


let var13 = prompt("Quel est ton prénom ?");
let var14 = prompt("Quel est ton nom ?");
alert(`Bonjour ${var14.toUpperCase()} ${var13}`);
